...
const page = () => {
  ...
  return (
    <div className="w-full h-full bg-[#0C0F11] flex py-16 justify-center">
    <div className=" h-full w-[90%] md:w-[80%] sc0:w-[60%] flex flex-col gap-4  items-start">
      <div id="heading" className="text-5xl text-white font-bold">
        Remex LP Vaults
      </div>
      <div id="text-content" className="text-gray-500 text-md">
        ...
        <Link href="/site/Vault/junior" className="w-full ">
            <div id="card1" className="bg-[#0c0f11] rounded-xl w-full border-[0.2px] py-6 px-10 border-gray-800 relative flex flex-col gap-3 hover:border-white transition duration-5000">
                ...
                <div id="card-headings" className="flex flex-col items-start gap-1"> 
                  <span id="card-heading" className="text-3xl text-white font-bold">Junior Tranche</span>
                ...
                <div id="container" className="rounded-xl bg-[#181A20] flex flex-col gap-3 p-4 mb-5"> 
                  <div id="current" className="flex justify-between w-full">
                    <span className="text-md text-gray-400">Current Deposits</span>
                    <span className="text-md text-white">{juniorTrancheData.currentDeposit} USDC</span>
                  </div>
                  ...
                  <div id="maximum" className="flex justify-between w-full">
                    <span className="text-md text-gray-400">Max. Value Capacity</span>
                    <span className="text-md text-white">{juniorTrancheData.maxDeposit} USDC</span>
                  </div>
                </div>
            ...
            <div id="card2" className="bg-[#0c0f11] rounded-xl w-full border-[0.2px] py-6 px-10 border-gray-800 flex flex-col gap-3 relative hover:border-white transition duration-500">
              <Image src="/Images/gradients/gradient2.png" width={250} height={250} alt="background"  className="absolute right-0 top-1"/>
                ...
                <Image src="/Images/crypto/coin.png" width={50} height={50} alt="token"/>
                <div id="card-headings" className="flex flex-col items-start gap-1"> 
                  <span id="card-heading" className="text-3xl text-white font-bold">Senior Tranche</span>
                ...
                <div id="container" className="rounded-xl bg-[#181A20] flex flex-col gap-3 p-4 mb-5"> 
                  <div id="current" className="flex justify-between w-full">
                    <span className="text-md text-gray-400">Current Deposits</span>
                    <span className="text-md text-white">{seniorTrancheData.currentDeposit} USDC</span>
                  </div>
                  <div id="completion-bar" className={`w-full bg-[#634479] h-4 rounded-full relative`}>
                  ...
                  <div id="maximum" className="flex justify-between w-full">
                    <span className="text-md text-gray-400">Max. Value Capacity</span>
                    <span className="text-md text-white">{seniorTrancheData.maxDeposit} USDC</span>
                  </div>
                </div>
                <div id="info" className="flex flex-col gap-4">
                    <div id="info-text1" className="flex justify-between w-full">
