...
const page=()=>{
    ...
    return(
        <div className='flex flex-col items-center justify-center bg-gradient-to-r from-transparent via-[#201635] to-transparent'>
            <div className='text-5xl m-[1.5rem] font-semibold items-center justify-center sc2:justify-self-start w-[85%]'>
                <div>Statistics</div>
            </div>
            <div className='flex flex-col sc2:flex-row gap-[2rem] sc2:gap-[10rem] sc2:h-[10rem] m-[3rem]'>
                <div className='flex flex-col gap-[1rem] items-center justify-center w-[18rem] border border-1 border-neutral-600 p-[1rem] sc2:p-0  bg-[#111114] rounded-md'>
                    <div className='text-blue-900 text-xl border border-1 border-blue-900 p-2 rounded-full'><FaUserFriends /></div>
                    <div className='text-slate-300 text-lg font-semibold'>Users</div>
                ...
                <div className='flex flex-col gap-[1rem] items-center justify-center w-[18rem] border border-1 border-neutral-600 p-[1rem] sc2:p-0  bg-[#111114] rounded-md'>
                    ...
                    <div className='text-slate-300 text-lg font-semibold'>Total Volume Traded</div>
                    <div className='text-2xl text-white font-bold'>{Stats.volume}</div>
                </div>
                <div className='flex flex-col gap-[1rem] items-center justify-center w-[18rem] border border-1 border-neutral-600 p-[1rem] sc2:p-0 bg-[#111114] rounded-md'>
                    <div className='text-green-800 text-xl border border-1 border-green-800 p-2 rounded-full'>
                    <IoCubeSharp />
                    </div>
                    <div className='text-slate-300 text-lg font-semibold'>Total Trades</div>
                    <div className='text-2xl text-white font-bold'>{Stats.trades}</div>
                </div>
            </div>
            <div className='text-xl font-semibold text-neutral-600 justify-self-start w-[85%]'>Last updated: 6 hours ago</div>
            <div className='flex flex-col gap-[2rem] w-[90%] mt-[2rem] mb-[1rem] bg-[#111114] pt-[2.5rem] pb-[2.5rem] rounded-xl'>
                <div className='flex text-xs font-semibold text-[#C3C4CB] items-center justify-center '>
