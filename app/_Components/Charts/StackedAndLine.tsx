...
const StackedAndLine = ({data,uppercolor,lowercolor,linecolor}:{data?:any,uppercolor?:string,lowercolor?:string,linecolor?:string}) => {
  ...
  return (
    <ResponsiveContainer width="100%" height="100%">
      ...
      >
        ...
        <Line yAxisId="right" type="monotone" dataKey="pv" stroke={linecolor} strokeWidth={2} r={0}/>
      </ComposedChart>
    </ResponsiveContainer>
  );
}

export default StackedAndLine;
