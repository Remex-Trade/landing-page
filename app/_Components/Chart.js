...
import { fetchStockData } from '../_config/stockData';
import { format } from '../_config/formatData';
import ReactApexChart from 'react-apexcharts';
import { options } from '../_config/chartOptions';
...
const Chart = ({symbol}) => {
  ...
  // const formattedData = format(stockData);
