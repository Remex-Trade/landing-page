    ...
    return(
      ...
      <div className="flex gap-6 h-10 items-center px-4 mb-2">
          ...
          {buttons.map((button)=>{
              return(
                  <>
                      <button className="text-sm dark:text-white dark:hover:bg-[#2C2D2D]  dark:focus:bg-[#2C2D2D] text-black hover:bg-[#F7F4F7] focus:bg-[#F7F4F7] px-4 py-2 rounded-xl">{button}</button>
                  </>
              )
          })}
      </div>
